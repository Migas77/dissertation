...
\plan{
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \item \acs{PPDR}: \acs{IOPS}, \acs{FIDEGAG}
        \end{itemize}
        ...
        \item Derive the application requirements from the use case (NEED TO VERIFY THESE REQUIREMENTS):
        \begin{itemize}
            \item Guaranteed minimum UL throughput for video/telemetry data transmission;
        ...
        \item Include sequence diagram and sequence diagram this time prioritizing the NEF. Showcase the added complexity of the NEF implementation flow comparetively to CAMARA APIs.
    \end{enumerate}
}
